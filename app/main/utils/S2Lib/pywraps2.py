...
class S1Angle(_object):
    ...
    __repr__ = _swig_repr
    __swig_getmethods__["Radians"] = lambda x: _pywraps2.S1Angle_Radians
    if _newclass:
        Radians = staticmethod(_pywraps2.S1Angle_Radians)
    __swig_getmethods__["Degrees"] = lambda x: _pywraps2.S1Angle_Degrees
    if _newclass:
        Degrees = staticmethod(_pywraps2.S1Angle_Degrees)
    __swig_getmethods__["E5"] = lambda x: _pywraps2.S1Angle_E5
    if _newclass:
        E5 = staticmethod(_pywraps2.S1Angle_E5)
    __swig_getmethods__["E6"] = lambda x: _pywraps2.S1Angle_E6
    if _newclass:
        E6 = staticmethod(_pywraps2.S1Angle_E6)
    __swig_getmethods__["E7"] = lambda x: _pywraps2.S1Angle_E7
    if _newclass:
        E7 = staticmethod(_pywraps2.S1Angle_E7)
    __swig_getmethods__["UnsignedE6"] = lambda x: _pywraps2.S1Angle_UnsignedE6
    if _newclass:
    ...
    def __idiv__(self, m):
        return _pywraps2.S1Angle___idiv__(self, m)
...
class S2CellId(_object):
    ...
    def __init__(self, *args):
        ...
        try:
            ...
            self.this = this
    __swig_getmethods__["FromFacePosLevel"] = lambda x: _pywraps2.S2CellId_FromFacePosLevel
    if _newclass:
    ...
    __swig_getmethods__["Begin"] = lambda x: _pywraps2.S2CellId_Begin
    if _newclass:
        Begin = staticmethod(_pywraps2.S2CellId_Begin)
    __swig_getmethods__["End"] = lambda x: _pywraps2.S2CellId_End
    if _newclass:
        End = staticmethod(_pywraps2.S2CellId_End)

    def ToToken(self):
        return _pywraps2.S2CellId_ToToken(self)
    __swig_getmethods__["FromToken"] = lambda x: _pywraps2.S2CellId_FromToken
    if _newclass:
    ...
    __swig_getmethods__["FromFaceIJ"] = lambda x: _pywraps2.S2CellId_FromFaceIJ
    if _newclass:
...
class S2Cap(_object):
    ...
    def __init__(self, *args):
        ...
        try:
            ...
            self.this = this
    __swig_getmethods__["FromPoint"] = lambda x: _pywraps2.S2Cap_FromPoint
    if _newclass:
        FromPoint = staticmethod(_pywraps2.S2Cap_FromPoint)
    __swig_getmethods__["Empty"] = lambda x: _pywraps2.S2Cap_Empty
    if _newclass:
        Empty = staticmethod(_pywraps2.S2Cap_Empty)
    __swig_getmethods__["Full"] = lambda x: _pywraps2.S2Cap_Full
    if _newclass:
...
class S2LatLng(_object):
    ...
    def __init__(self, *args):
        ...
        try:
            ...
            self.this = this
    __swig_getmethods__["FromRadians"] = lambda x: _pywraps2.S2LatLng_FromRadians
    if _newclass:
        FromRadians = staticmethod(_pywraps2.S2LatLng_FromRadians)
    __swig_getmethods__["FromDegrees"] = lambda x: _pywraps2.S2LatLng_FromDegrees
    if _newclass:
        FromDegrees = staticmethod(_pywraps2.S2LatLng_FromDegrees)
    __swig_getmethods__["FromE6"] = lambda x: _pywraps2.S2LatLng_FromE6
    if _newclass:
        FromE6 = staticmethod(_pywraps2.S2LatLng_FromE6)
    __swig_getmethods__["FromE7"] = lambda x: _pywraps2.S2LatLng_FromE7
    if _newclass:
        FromE7 = staticmethod(_pywraps2.S2LatLng_FromE7)
    __swig_getmethods__["FromUnsignedE6"] = lambda x: _pywraps2.S2LatLng_FromUnsignedE6
    if _newclass:
        FromUnsignedE6 = staticmethod(_pywraps2.S2LatLng_FromUnsignedE6)
    __swig_getmethods__["FromUnsignedE7"] = lambda x: _pywraps2.S2LatLng_FromUnsignedE7
    if _newclass:
...
class S2LatLngRect(_object):
    ...
    def __init__(self, *args):
        ...
        try:
            ...
            self.this = this
    __swig_getmethods__["FromCenterSize"] = lambda x: _pywraps2.S2LatLngRect_FromCenterSize
    if _newclass:
        FromCenterSize = staticmethod(_pywraps2.S2LatLngRect_FromCenterSize)
    __swig_getmethods__["FromPoint"] = lambda x: _pywraps2.S2LatLngRect_FromPoint
    if _newclass:
        FromPoint = staticmethod(_pywraps2.S2LatLngRect_FromPoint)
    __swig_getmethods__["FromPointPair"] = lambda x: _pywraps2.S2LatLngRect_FromPointPair
    if _newclass:
    ...
    __swig_getmethods__["Empty"] = lambda x: _pywraps2.S2LatLngRect_Empty
    if _newclass:
        Empty = staticmethod(_pywraps2.S2LatLngRect_Empty)
    __swig_getmethods__["Full"] = lambda x: _pywraps2.S2LatLngRect_Full
    if _newclass:
...
class S2Polygon(_object):
    ...
    __swig_getmethods__["GetOverlapFractions"] = lambda x: _pywraps2.S2Polygon_GetOverlapFractions
    if _newclass:
...
class S2CellUnion(_object):
    ...
    __swig_getmethods__["Normalize"] = lambda x: _pywraps2.S2CellUnion_Normalize
    if _newclass:
